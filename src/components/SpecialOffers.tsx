    ...
    <div className="bg-gray-50 py-8">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-6">
          ...
          <h1>আমরা দুঃখিত জুতো ওয়েবসাইটে আপডেট করতে পারিনি খুব তাড়াতাড়ি আপনার৷ অনলাইনে দেখতে পারবেন আপনার পছন্দের জুতো </h1>
            <h2>সেল শুরু হয়ে গেছে তাড়াতাড়ি দোকানে এসে নিয়ে যান আপনার পছন্দের জুতো এবং সাথে আকার্সনীয় উপহার</h2>
        </div>
        ...
        <div className="mt-6 text-center">
          ...
          <h1>আমরা দুঃখিত জুতো ওয়েবসাইটে আপডেট করতেপারিনি খুব তাড়াতাড়ি আপনার৷ অনলাইনে দেখতে পারবেন আপনার পছন্দের জুতো </h1>
            <h2>সেল শুরু হয়ে গেছে তাড়াতাড়ি দোকানে এসে নিয়েযান আপনার পছন্দের জুতো এবং সাথে আকার্সনীয় উপহার</h2>
        </div>
      </div>
    </div>
  );
