    ...
    <div className="bg-gray-50 py-8">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-6">
          ...
          <h1>আমরা দুঃখিত জুতো ওয়েবসাইটে আপডেট করতে পারিনি খুব তাড়াতাড়ি আপনার৷ অনলাইনে দেখতে পারবেন </h1>
        ...
        <div className="mt-6 text-center">
          ...
          <h1>আমরা দুঃখিত জুতো ওয়েবসাইটে আপডেট করতেপারিনি খুব তাড়াতাড়ি আপনার৷ অনলাইনে দেখতে পারবেন </h1>
